...
<%--Lecturer can view students who learn his subject--%>
<c:if test="${flag.equals('lecViewStuList')}">
    <body>
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
    ...
    <div class="container">
        ...
        <table class="table table-hover">
            ...
            <!--set arraylist values in to the table-->
            <c:forEach items="${students}" var="user" step="1" begin="0">
                <tr>
                    <td>${user.fname}</td>
                    <td>${user.lname}</td>
                    <td>${user.reg_year}</td>
