    ...
    <div class="row">
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            <div class="card card-signin my-5">
                <div class="card-body">
                    <h5 class="card-title text-center">Update Subject Form</h5>
                    <form action="/updateSubject" method="post" modelAttribute="updateSubjectForm" class="form-signin">

                        <%--this is use for display success message, After display success message then auto redirect dashboard.jsp--%>
                        <c:if test="${not empty updatedSubject}">
                            <%
                                out.println("<meta http-equiv='refresh' content='2;URL=/viewSubject'>");
                        ...
                        <div class="form-label-group">
                            <input type="text" id="sub_Name" class="form-control" placeholder="Subject Name"
                                   name="sub_name"
                                   value="${userData.get(0).getSub_name()}" required autofocus>
                        ...
                        <div class="form-label-group">
                            <input type="text" id="sub_code" class="form-control" placeholder="Subject Code"
                                   name="sub_code"
                                   value="${userData.get(0).getSub_code()}" readOnly=”true” required autofocus>
                        ...
                        <div class="form-label-group">
                            <input type="text" id="Lec_Id" class="form-control" placeholder="Lecturer ID"
                                   value="${userData.get(0).getLecturer_id()}" name="lecturer_id" required autofocus>
